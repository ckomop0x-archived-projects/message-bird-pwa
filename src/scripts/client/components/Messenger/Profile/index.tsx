  ...
  return (
    <>
      ...
      <main className="section no-pad-bot" id="index-banner">
        {props.error && (
          <div
            className="card-panel deep-orange darken-1 white-text z-depth-2"
            id="alert">
            <i className="material-icons left deep-orange-text text-lighten-4">
              warning
            </i>
            <strong>Error</strong>
            <em id="alert-message" />
        ...
        {props.message && (
          <div
            className="card-panel green darken-1 white-text z-depth-2"
            id="info">
            <i className="material-icons left green-text text-lighten-4">
              info
            </i>
